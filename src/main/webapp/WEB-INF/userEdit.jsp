...
<html>
	...
	<body data-new-gr-c-s-check-loaded="14.1040.0" data-gr-ext-installed="" style="background-image: url(Photos/OceanwavesBackdrop.jfif);"><span id="warning-container"><i data-reactroot=""></i></span>
		...
		<form:form action="/updateUser/${user.id}" method="POST" modelAttribute="user">
			<p>
				<form:label path="name" for="formControlInput" class="form-label">UserName:</form:label>
				<form:errors path="name"/>
				<form:input path="name" class="form-control" id="formControlInput"/>
			</p>
			<p>
				<form:label path="profilePic" for="formFile" class="form-label">Profile Pictures:</form:label>
				<form:errors path="profilePic"/>
				<form:input path="profilePic" class="form-control" id="formControlInput"/>
			</p>
			<p>
				<form:label path="email" for="formControlInput" class="form-label">Email:</form:label>
				<form:errors path="email"/>
				<form:input path="email" class="form-control" id="formControlInput" placeholder="name@example.com"/>
			</p>
			<p>
				<form:label path="password" for="formControlInput" class="form-label">Password:</form:label>
				<form:errors path="password"/>
				<form:input path="password" class="form-control" id="formControlInput"/>
			</p>
			<p>
				<form:label path="passwordConfirm" for="formControlInput" class="form-label">Password Confirm:</form:label>
				<form:errors path="passwordConfirm"/>
				<form:input path="passwordConfirm" class="form-control" id="formControlInput"/>
			</p>
			<button class="btn btn-primary">Submit</button>
		</form:form>
			<div class="btn-group">
				<a href="/destroyUser/${user.id}" class="btn btn-outline-primary">Delete</a>
			</div>
		</div>
