...
<html>
	...
	<body data-new-gr-c-s-check-loaded="14.1040.0" data-gr-ext-installed="" style="background-image: url(Photos/OceanwavesBackdrop.jfif);"><span id="warning-container"><i data-reactroot=""></i></span>
		...
		<div class="container-md col bg-white p-3 text-dark bg-opacity-50">
			<form:form action="/update/${picture.id}" method="POST" modelAttribute="picture">
				<p>
					<form:label path="picName" for="formControlInput" class="form-label">Picture:</form:label>
					<form:errors path="picName"/>
					<form:input path="picName" class="form-control" id="formControlInput"/>
				</p>
				<p>
					<form:label path="progressPic" for="formControlInput" class="form-label">Progress Picture file:</form:label>
					<form:errors path="progressPic"/>
					<form:input path="progressPic" class="form-control" id="formControlInput"/>
				</p>
